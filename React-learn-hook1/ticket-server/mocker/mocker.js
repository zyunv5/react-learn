...
module.exports = {
  'POST /rest/search': function (req, res) {
    return res.json({
      code: 0
    });
  },
  'GET /rest/cities': require('./rest/cities.json'),
  'GET /rest/search': function (req, res) {
    const { key } = req.query;
    return res.json({
      result: [
        {
  ...
  'GET /rest/query': function (req, res) {
  ...
  'GET /rest/ticket': function (req, res) {
  ...
  'GET /rest/schedule': function (req, res) {
    return res.json([
      {
        station: '北京南',
        arriveTime: null,
  ...
  'GET /rest/order': function (req, res) {
    const { date } = req.query;
